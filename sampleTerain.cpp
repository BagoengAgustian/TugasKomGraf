...
void pohon(int n, GLfloat size, GLfloat length, GLfloat x, GLfloat y, GLfloat z)
{
	if(n){
		if(n<2)
		...
		pohon(n-1, size*0.7, length*0.7, x, y, z); //right branch
		glRotatef(-90, 0.0, 1.0, 0.0);
		pohon(n-1, size*0.7, length*0.7, x, y, z ); //left branch
		glRotatef(-90, 1.0, 0.0, 1.0);
		pohon(n-1, size*0.7, length*0.7, x, y, z ); //upper branch
		glRotatef(90, 0.0, 01.0, 0.0);
		pohon(n-1, size*0.7, length*0.7, x, y, z ); //lower branch
		glPopMatrix();
	}
	else{
		glPushMatrix();
...
do {
	glPushMatrix();
		glTranslatef(100.0f + g, -8.0f, 110.0f + g);
		glRotatef(-90,1.0f, 0.0f, 0.0f);
		glScalef(2, 2, 2);
		divide_branch_third(6, 0.5, 7); //lets draw the tree
		glPopMatrix();
		i++;
		g=g+20.0f;
} while (i < 5);
...
//
//	glPushMatrix();
//	glTranslatef(110.0f, -8.0f, 120.0f);
//	glRotatef(-90,1.0f, 0.0f, 0.0f);
//	glScalef(2, 2, 2);
//	divide_branch_third(6, 0.5, 7); //lets draw the tree
//	glPopMatrix();
...
//
//	glPushMatrix();
//	glTranslatef(120.0f, -8.0f, 130.0f);
//	glRotatef(-90,1.0f, 0.0f, 0.0f);
//	glScalef(2, 2, 2);
//	divide_branch_third(6, 0.5, 7); //lets draw the tree
//	glPopMatrix();
